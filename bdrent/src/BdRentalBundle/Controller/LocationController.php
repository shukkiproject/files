...
use BdRentalBundle\Entity\Location;
use BdRentalBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BdRentalBundle\Form\LocationType', $location);
    ...
    {
        $deleteForm = $this->createDeleteForm($location);
        $editForm = $this->createForm('BdRentalBundle\Form\LocationType', $location);
